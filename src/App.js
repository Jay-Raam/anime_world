...
function App() {
  ...
  if (error) {
    ...
    return (
      <div>
        <p className="two-01">Waiting for Data...</p>
      </div>
    );
  }
            ...
            <div className="flex">
              ...
              {selectedAnime.producers.length > 0 &&
                ...
                selectedAnime.producers[0].url !== null && (
                  <a href={selectedAnime.producers[0].url}>Porducers Link</a>
                )}
            </div>
            <div className="flex">
                  ...
                  <div className="flex">
                    ...
                    {selectedAnime.themes[0].url &&
                      selectedAnime.themes[0].url !== null && (
                        <a href={selectedAnime.themes[0].url}>Theme Link</a>
                      )}
                  </div>
                )}
              </div>
                  ...
                  <div className="flex">
                    ...
                    {selectedAnime.genres[0].url &&
                      selectedAnime.genres[0].url !== null && (
                        <a href={selectedAnime.genres[0].url}>Genres Link</a>
                      )}
                  </div>
                )}
              </div>
